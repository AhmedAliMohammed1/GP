...
def TSR_ON():
    ...
    #from shared_resources import shared_ser , TSR_STATUS , laptop_port , baud_rate , web_cam_id , external_cam_id , TSR_ON_FLAG , TSR_OFF_FLAG , TSR_START_OF_FRAME , TSR_END_OF_FRAME
 ...
 while True:
  ...
  while(TSR_STATUS[0]==TSR_ON_FLAG):
    ...
    while True:
     ...
     shared_ser.write(TSR_START_OF_FRAME.encode('utf-8'))                #START OF 30 FRAME  (0x23)
     shared_ser.write(data_to_send.encode('utf-8'))
     shared_ser.write(TSR_END_OF_FRAME.encode('utf-8'))                  #END OF 30 FRAME    (0x2A)
